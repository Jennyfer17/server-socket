...
public class BankAccountService {
    ...
    public BankAccountService(FirebaseConfig firebaseConfig, ClientService clientService, TransactionService transactionService) {
    ...
    public BankAccount addBankAccount(String clientId, BankAccount bankAccount) throws InterruptedException, ExecutionException {
        ...
        System.out.println("Account added with number: " + bankAccount.getAccountNumber() + " at " + result.get().getUpdateTime());
    ...
    public BankAccount updateBankAccount(BankAccount account) throws InterruptedException, ExecutionException {
        ...
        result.get();
        System.out.println("Account updated with ID: " + account.getAccountNumber() + " at " + result.get().getUpdateTime());
        return document.toObject(BankAccount.class);
    }
    ...
    private Transaction createTransaction(String accountNumber, String accountNumberTo, double amount, String type) throws InterruptedException, ExecutionException {
    ...
    public String transferFunds(String accountNumberFrom, String accountNumberTo, double amount) throws InterruptedException, ExecutionException {
        ...
        return "You successfully transferred " + amount + " from account " + accountNumberFrom + " to account " + accountNumberTo + "\nYour new balance is " + accountFrom.getBalance();
    }

    public String depositFunds(String accountNumber, double amount) throws InterruptedException, ExecutionException {
        DocumentReference docRef = db.collection("bankAccount").document(accountNumber);
        ApiFuture<DocumentSnapshot> future = docRef.get();
        DocumentSnapshot document = future.get();
        ...
        return "You successfully deposited " + amount + " into account " + accountNumber + "\nYour new balance is " + account.getBalance();
    }

    public String withdraw(String accountNumber, double amount) throws InterruptedException, ExecutionException {
        DocumentReference docRef = db.collection("bankAccount").document(accountNumber);
        ApiFuture<DocumentSnapshot> future = docRef.get();
        DocumentSnapshot document = future.get();
        ...
        transactionService.createTransaction(transaction);
        updateBankAccount(account);
        return "You successfully withdrew " + amount + " from account " + accountNumber + "\nYour new balance is " + account.getBalance();
    }
